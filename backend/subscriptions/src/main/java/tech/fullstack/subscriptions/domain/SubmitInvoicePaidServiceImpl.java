...
import tech.fullstack.subscriptions.domain.PersistInvoiceRepository.PersistInvoiceRequest;
import tech.fullstack.subscriptions.domain.PersistInvoiceRepository.PersistInvoiceResult.InvoicePersisted;
import tech.fullstack.subscriptions.domain.PersistInvoiceRepository.PersistInvoiceResult.InvoicePersistenceFailed;
import tech.fullstack.subscriptions.domain.SubmitInvoicePaidService.Result.Failed;
import tech.fullstack.subscriptions.domain.SubmitInvoicePaidService.Result.IncorrectEventType;
import tech.fullstack.subscriptions.domain.SubmitInvoicePaidService.Result.Succeeded;

import static tech.fullstack.subscriptions.domain.StripeEventUtil.invoiceId;
import static tech.fullstack.subscriptions.domain.StripeEventUtil.status;
