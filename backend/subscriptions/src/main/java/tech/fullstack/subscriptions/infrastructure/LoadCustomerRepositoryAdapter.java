...
import tech.fullstack.subscriptions.domain.LoadCustomerRepository;
import tech.fullstack.subscriptions.domain.LoadCustomerRepository.LoadCustomerResult.CustomerLoadFailed;
import tech.fullstack.subscriptions.domain.LoadCustomerRepository.LoadCustomerResult.CustomerLoaded;
import tech.fullstack.subscriptions.domain.LoadCustomerRepository.LoadCustomerResult.CustomerNotFound;
