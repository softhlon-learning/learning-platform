...
import tech.fullstack.subscriptions.domain.FetchFreeTrialService;
import tech.fullstack.subscriptions.domain.FetchFreeTrialService.FreeTrialInfo;
import tech.fullstack.subscriptions.domain.FetchFreeTrialService.Result.Failed;
import tech.fullstack.subscriptions.domain.FetchFreeTrialService.Result.FreeTrialNotFoundFailed;
import tech.fullstack.subscriptions.domain.FetchFreeTrialService.Result.Succeeded;
...
import static tech.fullstack.subscriptions.gateway.controller.RestResources.FETCH_FREE_TRIAL;
