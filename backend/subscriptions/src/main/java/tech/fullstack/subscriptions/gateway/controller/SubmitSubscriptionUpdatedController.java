...
import tech.fullstack.subscriptions.domain.SubmitSubscriptionUpdatedService;
import tech.fullstack.subscriptions.domain.SubmitSubscriptionUpdatedService.Result.Failed;
import tech.fullstack.subscriptions.domain.SubmitSubscriptionUpdatedService.Result.IncorrectEventType;
import tech.fullstack.subscriptions.domain.SubmitSubscriptionUpdatedService.Result.IncorrectSubscription;
import tech.fullstack.subscriptions.domain.SubmitSubscriptionUpdatedService.Result.Succeeded;
...
import static tech.fullstack.subscriptions.gateway.controller.RestResources.SUBMIT_SUBSCRIPTION_UPDATED;
