...
import tech.fullstack.subscriptions.domain.CollectStripeEventService.Result.Failed;
import tech.fullstack.subscriptions.domain.CollectStripeEventService.Result.Succeeded;
import tech.fullstack.subscriptions.domain.PersistEventLogRepository.PersistEventLogResult.EventLogPersisted;
import tech.fullstack.subscriptions.domain.PersistEventLogRepository.PersistEventLogResult.EventLogPersistenceFailed;
