...
import tech.fullstack.subscriptions.domain.InitializeCheckoutService.Result.Failed;
import tech.fullstack.subscriptions.domain.InitializeCheckoutService.Result.Succeeded;
import tech.fullstack.subscriptions.domain.LoadCustomerByAccountRepository.Customer;
import tech.fullstack.subscriptions.domain.LoadCustomerByAccountRepository.LoadCustomerResult.CustomerLoadFailed;
import tech.fullstack.subscriptions.domain.LoadCustomerByAccountRepository.LoadCustomerResult.CustomerLoaded;
import tech.fullstack.subscriptions.domain.LoadCustomerByAccountRepository.LoadCustomerResult.CustomerNotFound;
import tech.fullstack.subscriptions.domain.PersistCheckoutRepository.PersistCheckoutSessionRequest;
import tech.fullstack.subscriptions.domain.PersistCheckoutRepository.PersistCheckoutSessionResult;
