...
import static io.softhlon.learning.accounts.infrastructure.InfrastructureConfiguration.BeanNames.APPLICATION_CONFIGURATION;
...
public class InfrastructureConfiguration {
    static class BeanNames {
        public static final String APPLICATION_CONFIGURATION =
              MODULE_PREFIX + "InfrastructureConfiguration";
    }
}
