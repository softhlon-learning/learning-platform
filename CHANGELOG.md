...
## 0.57.13
_release date: 2025-02-25_
 * frontend: Adjust height for quiz video-lecture components

## 0.57.12
_release date: 2025-02-25_
 * frontend: Adjust height for quiz-item.component
...
## 0.57.8
_release date: 2025-02-25_
* frontend: One more fix duplicated fetchFreeTrial calls
 ...
 * frontend: Increase height of error container
...
## 0.54.18
_release date: 2025-02-18_
 * frontend: Adjust column count for different screens (toc page)
 * frontend: Adjust navigation button width for different screens
 ...
 * accounts: Implement CreateAccountTokenRepositoryAdapter
 ...
 * general: Testing google SPAM criteria
 ...
 * general: Create dedicated certificates for mail.softhlon-learning.tech
 ...
 * courses: Fix hideLockedLectures method (adjust to the new free trial subscription type)
 ...
 * accounts: Review and update javadocs for class and interface headers - finalization

## 0.45.9
_release date: 2025-02-04_
 * accounts: Review and update javadocs for class and interface headers - part 2
 * accounts: Review and update javadocs for class and interface headers - part 3
 ...
 * courses: Add javadocs (domain and infrastructure) - part 2
 ...
 * subscriptions: Add javadocs (domain and infrastructure) - part 7
 ...
 * subscriptions: Tiny reformatting

## 0.44.9
_release date: 2025-02-03_
 * subscriptions: Add javadocs (domain and infrastructure) - part 1
 * subscriptions: Add javadocs (domain and infrastructure) - part 2
 ...
 * subscriptions: Update subscription as active on 'invoice.paid' event

## 0.43.3
_release date: 2025-02-02_
 * application: Add /api/v1/subscription/invoice-paid-event to permitted paths
 * subscriptions: Fix read payment status from 'invoice.paid' event
 * subscriptions: Test integration wirh Stripe
 ...
 * subscriptions: Get rid of request objects (part 1)
 ...
 * courses: Improve request/response log format in controllers
 * accounts: Improve request/response log format in controllers
...
## 0.39.0
_release date: 2025-01-30_
 * Implemented CreateSubscriptionServiceImpl
...
## 0.34.7
_release date: 2025-01-28_
 * Update of Angular course - part 2
...
## 0.31.6
_release date: 2025-01-27_
 * Update of API Design course - part 2
 ...
 * Code cleanup/add comments in model
 * Code cleanup/add comments in quiz-component
 * Code cleanup/add comments in reset-password.component
 ...
 * Replaced old types with verbs, in course definitions
 * Removed typeVerb method
 ...
 * Integrated UpdatePasswordServiceImpl with LoadPasswordTokenRepository
 ...
 * Added LoadPasswordTokenRepository interface
 * Added empty LoadPasswordTokenRepositoryAdapter
...
## 0.25.9
_release date: 2025-01-24_
 * New experimental code formatting in application and common
...
## 0.24.5
_release date: 2025-01-23_
 * Implemented CreatePasswordTokenRepositoryAdapter
 ...
 * General server/FreeBSD readiness
